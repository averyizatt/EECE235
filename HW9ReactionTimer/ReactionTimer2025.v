...
wire clk100Hz;
wire [6:0] Digit1, Digit0; // there were a few typos here in class on 11/4
...
always @(posedge clk100Hz) // consider changing to slower clock
   begin
		...
		case(state_reg)
			...
			delay: if (OnOff & myFLAG)	state_reg <= timing;
...
reaction2 React_MUT(clk100Hz, state_reg, myFLAG, ledn, Digit1, Digit0);
